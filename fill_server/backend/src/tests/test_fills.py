...
def test_get_random_fill(mocker):
    mocker_random = mocker.patch('src.fills.random.choice')
    mocker_quantity = mocker.patch('src.fills.random.randint')
    mocker_price = mocker.patch('src.fills.random.uniform')
